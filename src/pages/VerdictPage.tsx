...
const sub1 = {'Date': '01-07-2024 10:58:32', 'Problem': 'Two Sum', 'Verdict': 'Time-Limit Exceeded', 'Language': 'C++', 'Time': '20ms', 'Memory': '12MB', 'Test Cases': '3/5'}

const submissions : SubmissionData[] = [sub1, sub1, sub1]
export default function VerdictPage() {
  const columnNames = ['Date', 'Problem', 'Verdict', 'Language', 'Time', 'Memory', 'Test Cases']
    ...
    <Container sx={{ pt: 15 }}>
      ...
      >
        ...
        <Box>
          ...
          <Grid container>
            {columnNames.map((columnName, i) => 
              <Grid item xs = {columnWidths[i]} p = {1} textAlign={'center'} borderTop={'solid black 1px'}>
                <Typography variant = {'body2'}>
                  {sub1[columnName]}
                </Typography>
              </Grid>
