...
<img style = {{border: "black solid 1px"}} src="/lessons/complexity-analysis/assets/input_spec.png" alt="Screenshot of Input Specification from Two-Sum problem on O(fast)" width="1200px"/>
