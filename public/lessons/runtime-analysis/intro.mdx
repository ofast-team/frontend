...
## What is Big-O?
The most common way to express time complexity is Big-O notation. Big-O describes how an algorithm's runtime will grow as the size of the input grows. 
...
<div style = {{display: 'flex', gap: 20, justifyContent: 'space-between'}}>
    ...
    <img src="/lessons/runtime-analysis/assets/big_o_graph2.png" alt="Big O Graph" width="55%"/>
</div>